...
class GroupI(Group):
    """
    Classe para construção e manipulação da forma I.
    Parâmetros:
    ...
    def __init__(self, posx: int, posy: int, block_size: int):
        super().__init__(posx, posy, block_size, 4)
        self.color = pygame.Color(0xFF, 0xFF, 0x00)     # Amarelo
        self.blocks = list()
